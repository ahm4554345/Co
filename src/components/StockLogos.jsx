...
import chipsy from "../images/chipsy.svg";
import logo1 from "../images/pepsi.png";
import logo2 from "../images/5.jpg";
...
export function LaravelLogo(props) {
  return <Image src={logo1} width={500} height={500} {...props} alt="logo1" />;
}

export function TupleLogo(props) {
  return <Image src={logo2} width={500} height={500} {...props} alt="logo2" />;
}

export function TransistorLogo(props) {
  return <Image src={chipsy} width={500} height={500} {...props} alt="logo3" />;
}

export function DiageoLogo(props) {
  return <Image src={logo3} width={500} height={500} {...props} alt="logo4" />;
}

export function StaticKitLogo(props) {
  return <Image src={logo4} width={500} height={500} {...props} alt="logo5" />;
}

export function StatamicLogo(props) {
  return <Image src={logo5} width={500} height={500} {...props} alt="logo6" />;
}

export function MirageLogo(props) {
  return <Image src={logo6} width={500} height={500} {...props} alt="logo7" />;
}

export function ReversableLogo(props) {
  return <Image src={logo7} width={500} height={500} {...props} alt="logo8" />;
}
