...
import { navData } from "@/constants/new";
...
const Header = () => {
  ...
  return (
    <header
      className={`w-full fixed  top-0 z-50 backdrop-blur-[2px]  bg-white/40  ${
        isScrolled && "shadow-xl shadow-blue-300"
      }`}
    >
      <nav>
                    ...
                    {open && (
                      <>
                        ...
                        <Popover.Panel
                          ...
                          className="absolute inset-x-0 top-0 z-0 origin-top rounded-b-2xl bg-gray-400 px-6 pb-6 pt-32 shadow-2xl shadow-gray-900/20"
                        >
